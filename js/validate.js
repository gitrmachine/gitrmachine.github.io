...
for (var i = 0; i < ageranges.length; i++) {
    ageranges[i].addEventListener('click', (e) => {
        ...
        if (document.querySelectorAll('input[name="childrange"]:checked').length > document.getElementById('durationNightSlideChildren').value && document.getElementById('durationNightSlideChildren').value != 0) {
            errors = true;
            document.getElementById('ageRangeError').classList.remove('hidden')
            document.getElementById('ageRangeError').innerHTML = "Must have less age ranges than children."
        } 

        if (document.getElementById('durationNightSlideChildren').value == 0 && document.querySelector('input[name="childrange"][value="NA"]:checked') == null) {
            errors = true;
            document.getElementById('ageRangeError').classList.remove('hidden')
            document.getElementById('ageRangeError').innerHTML = "Must select 'N/A' if no children."
        } 

        if (document.querySelectorAll('input[name="childrange"]:checked').length < 1 || document.querySelectorAll('input[name="childrange"]:checked').length > 4) {
            errors = true;
            document.getElementById('ageRangeError').classList.remove('hidden')
            document.getElementById('ageRangeError').innerHTML = "Must only have four options selected at maximum and NA must be selected if there are no children"
        } 

        if (document.getElementById('durationNightSlideChildren').value != 0 && document.querySelector('input[name="childrange"][value="NA"]:checked') != null) {
            errors = true;
            document.getElementById('ageRangeError').classList.remove('hidden')
            document.getElementById('ageRangeError').innerHTML = "Each option can only be selected once and 'NA' cannot be selected"
        } 
...
function updateValues() {
    document.getElementById('confirmName').innerHTML = document.getElementById('nameField').value;
    document.getElementById('confirmEmail').innerHTML = document.getElementById('emailField').value;

    document.getElementById('confirmArrivalDate').innerHTML = document.getElementById('arrivalDate').value;
    document.getElementById('confirmNights').innerHTML = document.getElementById('durationNightSlide').value + " nights";

    document.getElementById('confirmArrivalPoint').innerHTML = document.querySelector('input[name="arrive"]:checked').value;
    document.getElementById('confirmNumberAdults').innerHTML = document.getElementById('durationNightSlideAdults').value;

    document.getElementById('confirmNumberChildren').innerHTML = document.getElementById('durationNightSlideChildren').value;
    ...
    document.getElementById('confirmTransportation').innerHTML = document.querySelector('input[name="transport"]:checked').value;
    ...
    document.getElementById('confirmNightsInArea').innerHTML = document.querySelector('input[name="nightsSpend"]:checked').value;
    document.getElementById('confirmFrequency').innerHTML = document.querySelector('input[name="activity"]:checked').value;

    document.getElementById('confirmDestinationScale').innerHTML = document.getElementById('scaleSlide').value;
    ...
    document.getElementById('confirmWord').innerHTML = document.querySelector('input[name="word"]:checked').value;
    document.getElementById('confirmBudget').innerHTML = document.querySelector('input[name="budget"]:checked').value;
}
...
document.getElementById('switchItnSubmit').addEventListener('click', (e) => {
    const data = {
        ...
        entry: document.querySelector('input[name="arrive"]:checked').value.toLowerCase(),
        adults: parseInt(document.getElementById('durationNightSlideAdults').value),
        children: parseInt(document.getElementById('durationNightSlideChildren').value),
        agerange: [],
        sleep: [],
        regionights: parseInt(document.querySelector('input[name="nightsSpend"]:checked').value),
        offbeat: parseInt(document.getElementById('scaleSlide').value),
        description: document.querySelector('input[name="word"]:checked').value.toLowerCase(),
        activities: [],
    };
    ...
    var childranges = document.querySelectorAll('input[name="childrange"]:checked')
    ...
    fetch('https://gitr.dev.vesulo.com/survey', {
        method: 'POST', // or 'PUT'
        headers: {
    ...
    data.transport = document.querySelector('input[name="transport"]:checked').value;
})